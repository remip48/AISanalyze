...
Extract all vessel positions within 50 km and ±5 minutes of the target locations and
...
closest in time to the target timestamps:
...
Alternatively, you can pass the centroids of a square grid to `data` and set `search_shape = "square"` to extract vessel positions within square grid cells:
