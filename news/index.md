...
- Replaced the relative CONTRIBUTING.md link in the README with a full
  GitHub URL.
...
- Avoided writing files to user directories; use temporary files instead
  for parallel processing logs.
...
- Optimized the parallel processing for AISinterpolate() with the option
  “exact_timestamp”.
